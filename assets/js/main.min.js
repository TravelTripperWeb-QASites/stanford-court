...
function addMarker(marker) {
    ...
    var content = '<div class="info-content">' + '<div class="map-detail"><h4>' + marker[1] + "</h4>" + "<p>" + marker[6] + "</p></div>" + "</div>";
    ...
    }), boxText = document.createElement("div"), myOptions = {
        content: boxText,
...
filterMarkers = function(category) {
    ...
    if ($(".mapview").attr("data-mapfor") == "contact") {} else {}
};
...
!function(e, t, i) {
    ...
    function o(t, o) {
        ...
        this.isTouch = "ontouchstart" in i.documentElement, this.s.slideEndAnimatoin && (this.s.hideControlOnEnd = !1), 
    ...
    o.prototype.init = function() {
        ...
        o.indexOf("lg=" + this.s.galleryId) > 0 && (i.index = parseInt(o.split("&slide=")[1], 10), 
        e("body").addClass("lg-from-hash"), e("body").hasClass("lg-on") || setTimeout(function() {
            i.build(i.index), e("body").addClass("lg-on");
        })), i.s.dynamic ? (i.$el.trigger("onBeforeOpen.lg"), i.index = i.s.index || 0, 
        e("body").hasClass("lg-on") || setTimeout(function() {
            ...
            i.$el.trigger("onBeforeOpen.lg"), i.index = i.s.index || i.$items.index(this), e("body").hasClass("lg-on") || (i.build(i.index), 
        ...
        }), i.slide(t, !1, !1), i.s.keyPress && i.keyPress(), i.$items.length > 1 && (i.arrow(), 
        setTimeout(function() {
            i.enableDrag(), i.enableSwipe();
        }, 50), i.s.mousewheel && i.mousewheel()), i.counter(), i.closeGallery(), i.$el.trigger("onAfterOpen.lg"), 
        ...
        var i, o = "", s = "", r = 0, a = "", l = this;
        for (e("body").append('<div class="lg-backdrop"></div>'), e(".lg-backdrop").css("transition-duration", this.s.backdropDuration + "ms"), 
        r = 0; r < this.$items.length; r++) o += '<div class="lg-item"></div>';
        ...
        ".lg-sub-html" === this.s.appendSubHtmlTo && (a = '<div class="lg-sub-html"></div>'), 
        i = '<div class="lg-outer ' + this.s.addClass + " " + this.s.startClass + '"><div class="lg" style="width:' + this.s.width + "; height:" + this.s.height + '"><div class="lg-inner">' + o + '</div><div class="lg-toolbar group"><span class="lg-close lg-icon"></span></div>' + s + a + "</div></div>", 
        e("body").append(i), this.$outer = e(".lg-outer"), this.$slide = this.$outer.find(".lg-item"), 
        this.s.useLeft ? (this.$outer.addClass("lg-use-left"), this.s.mode = "lg-slide") : this.$outer.addClass("lg-use-css3"), 
        l.setTop(), e(t).on("resize.lg orientationchange.lg", function() {
            setTimeout(function() {
                l.setTop();
            }, 100);
        ...
        this.prevScrollTop = e(t).scrollTop();
    }, o.prototype.setTop = function() {
        if ("100%" !== this.s.height) {
            var i = e(t).height(), o = (i - parseInt(this.s.height, 10)) / 2, s = this.$outer.find(".lg");
            i >= parseInt(this.s.height, 10) ? s.css("top", o + "px") : s.css("top", "0px");
        }
    }, o.prototype.doCss = function() {
        return !!function() {
            var e = [ "transition", "MozTransition", "WebkitTransition", "OTransition", "msTransition", "KhtmlTransition" ], t = i.documentElement, o = 0;
        ...
        var o = e.match(/\/\/(?:www\.)?youtu(?:\.be|be\.com)\/(?:watch\?v=|embed\/)?([a-z0-9\-\_\%]+)/i), s = e.match(/\/\/(?:www\.)?vimeo.com\/([0-9a-z\-_]+)/i), r = e.match(/\/\/(?:www\.)?dai.ly\/([0-9a-z\-_]+)/i);
        return o ? {
            youtube: o
        } : s ? {
            vimeo: s
        ...
        var i, o = null;
        if (this.s.dynamic ? this.s.dynamicEl[t].subHtmlUrl ? i = this.s.dynamicEl[t].subHtmlUrl : o = this.s.dynamicEl[t].subHtml : this.$items.eq(t).attr("data-sub-html-url") ? i = this.$items.eq(t).attr("data-sub-html-url") : o = this.$items.eq(t).attr("data-sub-html"), 
        !i) if (void 0 !== o && null !== o) {
            var s = o.substring(0, 1);
            o = "." === s || "#" === s ? e(o).html() : o;
        } else o = "";
        ".lg-sub-html" === this.s.appendSubHtmlTo ? i ? this.$outer.find(this.s.appendSubHtmlTo).load(i) : this.$outer.find(this.s.appendSubHtmlTo).html(o) : i ? this.$slide.eq(t).load(i) : this.$slide.eq(t).append(o), 
        void 0 !== o && null !== o && ("" === o ? this.$outer.find(this.s.appendSubHtmlTo).addClass("lg-empty-html") : this.$outer.find(this.s.appendSubHtmlTo).removeClass("lg-empty-html")), 
        this.$el.trigger("onAfterAppendSubHtml.lg", [ t ]);
    }, o.prototype.preload = function(e) {
        var t = 1, i = 1;
        for (t = 1; t <= this.s.preload && !(t >= this.$items.length - e); t++) this.loadContent(e + t, !1, 0);
        for (i = 1; i <= this.s.preload && !(e - i < 0); i++) this.loadContent(e - i, !1, 0);
    }, o.prototype.loadContent = function(i, o, s) {
        var r, a, l, n, d, u, h = this, c = !1, g = function(i) {
            for (var o = [], s = [], r = 0; r < i.length; r++) {
                var l = i[r].split(" ");
                "" === l[0] && l.splice(0, 1), s.push(l[0]), o.push(l[1]);
            }
            for (var n = e(t).width(), d = 0; d < o.length; d++) if (parseInt(o[d], 10) > n) {
                a = s[d];
                break;
            }
        };
        if (h.s.dynamic) {
            if (h.s.dynamicEl[i].poster && (c = !0, l = h.s.dynamicEl[i].poster), u = h.s.dynamicEl[i].html, 
            a = h.s.dynamicEl[i].src, h.s.dynamicEl[i].responsive) {
                g(h.s.dynamicEl[i].responsive.split(","));
            }
            n = h.s.dynamicEl[i].srcset, d = h.s.dynamicEl[i].sizes;
        } else {
            if (h.$items.eq(i).attr("data-poster") && (c = !0, l = h.$items.eq(i).attr("data-poster")), 
            u = h.$items.eq(i).attr("data-html"), a = h.$items.eq(i).attr("href") || h.$items.eq(i).attr("data-src"), 
            h.$items.eq(i).attr("data-responsive")) {
                g(h.$items.eq(i).attr("data-responsive").split(","));
            }
            n = h.$items.eq(i).attr("data-srcset"), d = h.$items.eq(i).attr("data-sizes");
        }
        var m = !1;
        h.s.dynamic ? h.s.dynamicEl[i].iframe && (m = !0) : "true" === h.$items.eq(i).attr("data-iframe") && (m = !0);
        var f = h.isVideo(a, i);
        if (!h.$slide.eq(i).hasClass("lg-loaded")) {
            if (m) h.$slide.eq(i).prepend('<div class="lg-video-cont" style="max-width:' + h.s.iframeMaxWidth + '"><div class="lg-video"><iframe class="lg-object" frameborder="0" src="' + a + '"  allowfullscreen="true"></iframe></div></div>'); else if (c) {
                var p = "";
                p = f && f.youtube ? "lg-has-youtube" : f && f.vimeo ? "lg-has-vimeo" : "lg-has-html5", 
                h.$slide.eq(i).prepend('<div class="lg-video-cont ' + p + ' "><div class="lg-video"><span class="lg-video-play"></span><img class="lg-object lg-has-poster" src="' + l + '" /></div></div>');
            } else f ? (h.$slide.eq(i).prepend('<div class="lg-video-cont "><div class="lg-video"></div></div>'), 
            h.$el.trigger("hasVideo.lg", [ i, a, u ])) : h.$slide.eq(i).prepend('<div class="lg-img-wrap"><img class="lg-object lg-image" src="' + a + '" /></div>');
            if (h.$el.trigger("onAferAppendSlide.lg", [ i ]), r = h.$slide.eq(i).find(".lg-object"), 
            d && r.attr("sizes", d), n) {
                r.attr("srcset", n);
                try {
                    picturefill({
        ...
        }), f && f.html5 && !c && h.$slide.eq(i).addClass("lg-complete"), o === !0 && (h.$slide.eq(i).hasClass("lg-complete") ? h.preload(i) : h.$slide.eq(i).find(".lg-object").on("load.lg error.lg", function() {
            h.preload(i);
        }));
    }, o.prototype.slide = function(t, i, o) {
        var s = this.$outer.find(".lg-current").index(), r = this;
        if (!r.lGalleryOn || s !== t) {
            var a = this.$slide.length, l = r.lGalleryOn ? this.s.speed : 0, n = !1, d = !1;
            if (!r.lgBusy) {
                if (this.s.download) {
                    var u;
                    u = r.s.dynamic ? r.s.dynamicEl[t].downloadUrl !== !1 && (r.s.dynamicEl[t].downloadUrl || r.s.dynamicEl[t].src) : "false" !== r.$items.eq(t).attr("data-download-url") && (r.$items.eq(t).attr("data-download-url") || r.$items.eq(t).attr("href") || r.$items.eq(t).attr("data-src")), 
                    u ? (e("#lg-download").attr("href", u), r.$outer.removeClass("lg-hide-download")) : r.$outer.addClass("lg-hide-download");
                }
                if (this.$el.trigger("onBeforeSlide.lg", [ s, t, i, o ]), r.lgBusy = !0, clearTimeout(r.hideBartimeout), 
                ".lg-sub-html" === this.s.appendSubHtmlTo && setTimeout(function() {
                    r.addHtml(t);
                }, l), this.arrowDisable(t), i) {
                    var h = t - 1, c = t + 1;
                    0 === t && s === a - 1 ? (c = 0, h = a - 1) : t === a - 1 && 0 === s && (c = 0, 
                    h = a - 1), this.$slide.removeClass("lg-prev-slide lg-current lg-next-slide"), r.$slide.eq(h).addClass("lg-prev-slide"), 
                    r.$slide.eq(c).addClass("lg-next-slide"), r.$slide.eq(t).addClass("lg-current");
                } else r.$outer.addClass("lg-no-trans"), this.$slide.removeClass("lg-prev-slide lg-next-slide"), 
                t < s ? (d = !0, 0 !== t || s !== a - 1 || o || (d = !1, n = !0)) : t > s && (n = !0, 
                t !== a - 1 || 0 !== s || o || (d = !0, n = !1)), d ? (this.$slide.eq(t).addClass("lg-prev-slide"), 
                this.$slide.eq(s).addClass("lg-next-slide")) : n && (this.$slide.eq(t).addClass("lg-next-slide"), 
                this.$slide.eq(s).addClass("lg-prev-slide")), setTimeout(function() {
                    r.$slide.removeClass("lg-current"), r.$slide.eq(t).addClass("lg-current"), r.$outer.removeClass("lg-no-trans");
                }, 50);
                r.lGalleryOn ? (setTimeout(function() {
                    r.loadContent(t, !0, 0);
                }, this.s.speed + 50), setTimeout(function() {
                    r.lgBusy = !1, r.$el.trigger("onAfterSlide.lg", [ s, t, i, o ]);
                }, this.s.speed)) : (r.loadContent(t, !0, r.s.backdropDuration), r.lgBusy = !1, 
                r.$el.trigger("onAfterSlide.lg", [ s, t, i, o ])), r.lGalleryOn = !0, this.s.counter && e("#lg-counter-current").text(t + 1);
            }
        }
    }, o.prototype.goToNextSlide = function(e) {
        var t = this;
        t.lgBusy || (t.index + 1 < t.$slide.length ? (t.index++, t.$el.trigger("onBeforeNextSlide.lg", [ t.index ]), 
        t.slide(t.index, e, !1)) : t.s.loop ? (t.index = 0, t.$el.trigger("onBeforeNextSlide.lg", [ t.index ]), 
        t.slide(t.index, e, !1)) : t.s.slideEndAnimatoin && (t.$outer.addClass("lg-right-end"), 
        setTimeout(function() {
            t.$outer.removeClass("lg-right-end");
        }, 400)));
    }, o.prototype.goToPrevSlide = function(e) {
        var t = this;
        t.lgBusy || (t.index > 0 ? (t.index--, t.$el.trigger("onBeforePrevSlide.lg", [ t.index, e ]), 
        t.slide(t.index, e, !1)) : t.s.loop ? (t.index = t.$items.length - 1, t.$el.trigger("onBeforePrevSlide.lg", [ t.index, e ]), 
        t.slide(t.index, e, !1)) : t.s.slideEndAnimatoin && (t.$outer.addClass("lg-left-end"), 
        setTimeout(function() {
        ...
        this.$items.length > 1 && e(t).on("keyup.lg", function(e) {
            i.$items.length > 1 && (37 === e.keyCode && (e.preventDefault(), i.goToPrevSlide()), 
            39 === e.keyCode && (e.preventDefault(), i.goToNextSlide()));
        ...
        var o = i - t;
        this.$outer.addClass("lg-dragging"), this.setTranslate(this.$slide.eq(this.index), o, 0), 
        ...
        setTimeout(function() {
            t.$outer.removeClass("lg-dragging"), e < 0 && Math.abs(e) > t.s.swipeThreshold ? t.goToNextSlide(!0) : e > 0 && Math.abs(e) > t.s.swipeThreshold ? t.goToPrevSlide(!0) : Math.abs(e) < 5 && t.$el.trigger("onSlideClick.lg"), 
            t.$slide.removeAttr("style");
        }), setTimeout(function() {
            t.$outer.hasClass("lg-dragging") || "lg-slide" === t.s.mode || t.$outer.removeClass("lg-slide");
        }, t.s.speed + 100);
    }, o.prototype.enableSwipe = function() {
        var e = this, t = 0, i = 0, o = !1;
        e.s.enableSwipe && e.isTouch && e.doCss() && (e.$slide.on("touchstart.lg", function(i) {
            e.$outer.hasClass("lg-zoomed") || e.lgBusy || (i.preventDefault(), e.manageSwipeClass(), 
            t = i.originalEvent.targetTouches[0].pageX);
        }), e.$slide.on("touchmove.lg", function(s) {
            e.$outer.hasClass("lg-zoomed") || (s.preventDefault(), i = s.originalEvent.targetTouches[0].pageX, 
            e.touchMove(t, i), o = !0);
        }), e.$slide.on("touchend.lg", function() {
            e.$outer.hasClass("lg-zoomed") || (o ? (o = !1, e.touchEnd(i - t)) : e.$el.trigger("onSlideClick.lg"));
        }));
    }, o.prototype.enableDrag = function() {
        var i = this, o = 0, s = 0, r = !1, a = !1;
        i.s.enableDrag && !i.isTouch && i.doCss() && (i.$slide.on("mousedown.lg", function(t) {
            ...
            i.lgBusy || (i.manageSwipeClass(), o = t.pageX, r = !0, i.$outer.scrollLeft += 1, 
            i.$outer.scrollLeft -= 1, i.$outer.removeClass("lg-grab").addClass("lg-grabbing"), 
            i.$el.trigger("onDragstart.lg")));
        }), e(t).on("mousemove.lg", function(e) {
            r && (a = !0, s = e.pageX, i.touchMove(o, s), i.$el.trigger("onDragmove.lg"));
        }), e(t).on("mouseup.lg", function(t) {
            a ? (a = !1, i.touchEnd(s - o), i.$el.trigger("onDragend.lg")) : (e(t.target).hasClass("lg-object") || e(t.target).hasClass("lg-video-play")) && i.$el.trigger("onSlideClick.lg"), 
            r && (r = !1, i.$outer.removeClass("lg-grabbing").addClass("lg-grab"));
        }));
        ...
        this.$slide.removeClass("lg-next-slide lg-prev-slide"), t > -1 && this.$slide.eq(t).addClass("lg-prev-slide"), 
        ...
        var o = this;
        i || o.$el.trigger("onBeforeClose.lg"), e(t).scrollTop(o.prevScrollTop), i && (o.s.dynamic || this.$items.off("click.lg click.lgcustom"), 
        e.removeData(o.el, "lightGallery")), this.$el.off(".lg.tm"), e.each(e.fn.lightGallery.modules, function(e) {
            o.modules[e] && o.modules[e].destroy();
        }), this.lGalleryOn = !1, clearTimeout(o.hideBartimeout), this.hideBartimeout = !1, 
        e(t).off(".lg"), e("body").removeClass("lg-on lg-from-hash"), o.$outer && o.$outer.removeClass("lg-visible"), 
        e(".lg-backdrop").removeClass("in"), setTimeout(function() {
            o.$outer && o.$outer.remove(), e(".lg-backdrop").remove(), i || o.$el.trigger("onCloseAfter.lg");
...
!function(e, t) {
    ...
    var o = {
        ...
        return this.core = e(t).data("lightGallery"), this.core.s = e.extend({}, o, this.core.s), 
        this.$el = e(t), this.$thumbOuter = null, this.thumbOuterWidth = 0, this.thumbTotalWidth = this.core.$items.length * (this.core.s.thumbWidth + this.core.s.thumbMargin), 
    ...
    r.prototype.init = function() {
        ...
        function o(e, t, o) {
            var r, s = a.core.isVideo(e, o) || {}, l = "";
            s.youtube || s.vimeo || s.dailymotion ? s.youtube ? r = a.core.s.loadYoutubeThumbnail ? "//img.youtube.com/vi/" + s.youtube[1] + "/" + a.core.s.youtubeThumbSize + ".jpg" : t : s.vimeo ? a.core.s.loadVimeoThumbnail ? (r = "//i.vimeocdn.com/video/error_" + n + ".jpg", 
            l = s.vimeo[1]) : r = t : s.dailymotion && (r = a.core.s.loadDailymotionThumbnail ? "//www.dailymotion.com/thumbnail/video/" + s.dailymotion[1] : t) : r = t, 
            i += '<div data-vimeo-id="' + l + '" class="lg-thumb-item" style="width:' + a.core.s.thumbWidth + "px; margin-right: " + a.core.s.thumbMargin + 'px"><img src="' + r + '" /></div>', 
            l = "";
        }
        var r, a = this, i = "", n = "", s = '<div class="lg-thumb-outer"><div class="lg-thumb group"></div></div>';
        ...
        if (a.core.$outer.addClass("lg-has-thumb"), a.core.$outer.find(".lg").append(s), 
        a.$thumbOuter = a.core.$outer.find(".lg-thumb-outer"), a.thumbOuterWidth = a.$thumbOuter.width(), 
        a.core.s.animateThumb && a.core.$outer.find(".lg-thumb").css({
            width: a.thumbTotalWidth + "px",
            position: "relative"
        }), this.core.s.animateThumb && a.$thumbOuter.css("height", a.core.s.thumbContHeight + "px"), 
        a.core.s.dynamic) for (var l = 0; l < a.core.s.dynamicEl.length; l++) o(a.core.s.dynamicEl[l].src, a.core.s.dynamicEl[l].thumb, l); else a.core.$items.each(function(t) {
            a.core.s.exThumbImage ? o(e(this).attr("href") || e(this).attr("data-src"), e(this).attr(a.core.s.exThumbImage), t) : o(e(this).attr("href") || e(this).attr("data-src"), e(this).find("img").attr("src"), t);
        });
        a.core.$outer.find(".lg-thumb").html(i), r = a.core.$outer.find(".lg-thumb-item"), 
        r.each(function() {
            var t = e(this), o = t.attr("data-vimeo-id");
            o && e.getJSON("http://www.vimeo.com/api/v2/video/" + o + ".json?callback=?", {
                format: "json"
            }, function(e) {
            ...
            var t = e(this);
            setTimeout(function() {
                (a.thumbClickable && !a.core.lgBusy || !a.core.doCss()) && (a.core.index = t.index(), 
                a.core.slide(a.core.index, !1, !0));
            }, 50);
        ...
        if (this.core.s.animateThumb) {
            ...
            this.left = (this.core.s.thumbWidth + this.core.s.thumbMargin) * e - 1 - o, this.left > this.thumbTotalWidth - this.thumbOuterWidth && (this.left = this.thumbTotalWidth - this.thumbOuterWidth), 
            this.left < 0 && (this.left = 0), this.core.lGalleryOn ? (t.hasClass("on") || this.core.$outer.find(".lg-thumb").css("transition-duration", this.core.s.speed + "ms"), 
        ...
        var o = this, r = 0, a = 0, i = !1, n = !1, s = 0;
        o.$thumbOuter.addClass("lg-grab"), o.core.$outer.find(".lg-thumb").on("mousedown.lg.thumb", function(e) {
            o.thumbTotalWidth > o.thumbOuterWidth && (e.preventDefault(), r = e.pageX, i = !0, 
            o.core.$outer.scrollLeft += 1, o.core.$outer.scrollLeft -= 1, o.thumbClickable = !1, 
            o.$thumbOuter.removeClass("lg-grab").addClass("lg-grabbing"));
        }), e(t).on("mousemove.lg.thumb", function(e) {
            i && (s = o.left, n = !0, a = e.pageX, o.$thumbOuter.addClass("lg-dragging"), s -= a - r, 
            s > o.thumbTotalWidth - o.thumbOuterWidth && (s = o.thumbTotalWidth - o.thumbOuterWidth), 
            s < 0 && (s = 0), o.setTranslate(s));
        }), e(t).on("mouseup.lg.thumb", function() {
            n ? (n = !1, o.$thumbOuter.removeClass("lg-dragging"), o.left = s, Math.abs(a - r) < o.core.s.swipeThreshold && (o.thumbClickable = !0)) : o.thumbClickable = !0, 
            i && (i = !1, o.$thumbOuter.removeClass("lg-grabbing").addClass("lg-grab"));
        });
    }, r.prototype.enableThumbSwipe = function() {
        var e = this, t = 0, o = 0, r = !1, a = 0;
        e.core.$outer.find(".lg-thumb").on("touchstart.lg", function(o) {
            e.thumbTotalWidth > e.thumbOuterWidth && (o.preventDefault(), t = o.originalEvent.targetTouches[0].pageX, 
            e.thumbClickable = !1);
        }), e.core.$outer.find(".lg-thumb").on("touchmove.lg", function(i) {
            e.thumbTotalWidth > e.thumbOuterWidth && (i.preventDefault(), o = i.originalEvent.targetTouches[0].pageX, 
            r = !0, e.$thumbOuter.addClass("lg-dragging"), a = e.left, a -= o - t, a > e.thumbTotalWidth - e.thumbOuterWidth && (a = e.thumbTotalWidth - e.thumbOuterWidth), 
            a < 0 && (a = 0), e.setTranslate(a));
        }), e.core.$outer.find(".lg-thumb").on("touchend.lg", function() {
            e.thumbTotalWidth > e.thumbOuterWidth && r ? (r = !1, e.$thumbOuter.removeClass("lg-dragging"), 
            Math.abs(o - t) < e.core.s.swipeThreshold && (e.thumbClickable = !0), e.left = a) : e.thumbClickable = !0;
        });
    }, r.prototype.toogle = function() {
        var e = this;
        e.core.s.toogleThumb && (e.core.$outer.addClass("lg-can-toggle"), e.$thumbOuter.append('<span class="lg-toogle-thumb lg-icon"></span>'), 
        ...
        e(t).on("keydown.lg.thumb", function(e) {
            38 === e.keyCode ? (e.preventDefault(), o.core.$outer.addClass("lg-thumb-open")) : 40 === e.keyCode && (e.preventDefault(), 
            o.core.$outer.removeClass("lg-thumb-open"));
        });
    }, r.prototype.destroy = function() {
        this.core.s.thumbnail && this.core.$items.length > 1 && (e(t).off("resize.lg.thumb orientationchange.lg.thumb keydown.lg.thumb"), 
...
!function() {
    ...
    t.version = "0.7.1", t.utils = {}, t.utils.warn = function(t) {
        ...
        e.label = n, this.registeredFunctions[n] = e;
    }, t.Pipeline = function() {
        this._stack = [];
        ...
        e.label = n, t.Pipeline.registeredFunctions[e.label] = e;
        ...
        for (var e = this.list, n = t.list, i = 0; e && n; ) e.idx < n.idx ? e = e.next : e.idx > n.idx ? n = n.next : (i += e.val * n.val, 
        e = e.next, n = n.next);
        return i;
        ...
        o > t && (n = r), i = n - e, r = e + Math.floor(i / 2), o = this.elements[r];
        ...
        this._fields = [], this._ref = "id", this.pipeline = new t.Pipeline(), this.documentStore = new t.Store(), 
        this.tokenStore = new t.TokenStore(), this.corpusTokens = new t.SortedSet(), this.eventEmitter = new t.EventEmitter(), 
        this.tokenizerFn = t.tokenizer, this._idfCache = {}, this.on("add", "remove", "update", function() {
            this._idfCache = {};
        }.bind(this));
        ...
        var n = new this();
        return n._fields = e.fields, n._ref = e.ref, n.tokenizer = t.tokenizer.load(e.tokenizer), 
        n.documentStore = t.Store.load(e.documentStore), n.tokenStore = t.TokenStore.load(e.tokenStore), 
        n.corpusTokens = t.SortedSet.load(e.corpusTokens), n.pipeline = t.Pipeline.load(e.pipeline), 
        n;
        ...
        var t = {
            ...
            ful: "",
            ness: ""
        }, n = "[^aeiou]", i = "[aeiouy]", r = n + "[^aeiouy]*", o = i + "[aeiou]*", s = "^(" + r + ")?" + o + r, a = "^(" + r + ")?" + o + r + "(" + o + ")?$", h = "^(" + r + ")?" + o + r + o + r, u = "^(" + r + ")?" + i, l = new RegExp(s), c = new RegExp(h), f = new RegExp(a), d = new RegExp(u), p = /^(.+?)(ss|i)es$/, v = /^(.+?)([^s])s$/, g = /^(.+?)eed$/, m = /^(.+?)(ed|ing)$/, y = /.$/, S = /(at|bl|iz)$/, w = new RegExp("([^aeiouylsz])\\1$"), k = new RegExp("^" + r + i + "[^aeiouwxy]$"), x = /^(.+?[^aeiou])y$/, b = /^(.+?)(ational|tional|enci|anci|izer|bli|alli|entli|eli|ousli|ization|ation|ator|alism|iveness|fulness|ousness|aliti|iviti|biliti|logi)$/, E = /^(.+?)(icate|ative|alize|iciti|ical|ful|ness)$/, F = /^(.+?)(al|ance|ence|er|ic|able|ible|ant|ement|ment|ent|ou|ism|ate|iti|ous|ive|ize)$/, _ = /^(.+?)(s|t)(ion)$/, z = /^(.+?)e$/, O = /ll$/, P = new RegExp("^" + r + i + "[^aeiouwxy]$"), T = function(n) {
            var i, r, o, s, a, h, u;
            if (n.length < 3) return n;
            if (o = n.substr(0, 1), "y" == o && (n = o.toUpperCase() + n.substr(1)), s = p, 
            a = v, s.test(n) ? n = n.replace(s, "$1$2") : a.test(n) && (n = n.replace(a, "$1$2")), 
            s = g, a = m, s.test(n)) {
                var T = s.exec(n);
                s = l, s.test(T[1]) && (s = y, n = n.replace(s, ""));
            } else if (a.test(n)) {
                var T = a.exec(n);
                i = T[1], a = d, a.test(i) && (n = i, a = S, h = w, u = k, a.test(n) ? n += "e" : h.test(n) ? (s = y, 
            ...
            return s = O, a = c, s.test(n) && a.test(n) && (s = y, n = n.replace(s, "")), "y" == o && (n = o.toLowerCase() + n.substr(1)), 
            n;
        };
        return T;
...
(function($) {
    $.fn.rezGallery = function(options) {
        ...
        console.log(options.offerselector + " & length" + galleryLength);
        ...
        success: function(response) {
            ...
            setTimeout(function() {
                $.each(showInstaFeeds, function(i, item) {
                    ...
                    $('<div class="feed background-cover" style="background-image:url(' + item.node.thumbnail_src + ');"><a href="' + instaFeedUrl + item.node.shortcode + '" target="_blank"><i class="fab fa-instagram"></i><p class="insta-icons">@stanfordcourt <br><i class="far fa-heart" aria-hidden="true"></i>' + item.node.edge_liked_by.count + ' <i class="far fa-comment" aria-hidden="true"></i>' + item.node.edge_media_to_comment.count + "</p></a></div>").appendTo(".instagram-feed");
                });
...
$(document).ready(function() {
    ...
    $(".filter").on("click", function() {
        ...
        if (!$this.hasClass("active")) {
            ...
            $filter == "all" ? $(".fancybox").attr("data-fancybox-group", "gallery").not(":visible").fadeIn() : $(".fancybox").fadeOut(0).filter(function() {
                return $(this).data("filter") == $filter;
            }).attr("data-fancybox-group", $filter).fadeIn(1e3);
            setTimeout(function() {
...
$(document).ready(function() {
    function checkForm() {
        ...
        $(this.form).find("select:required").each(function() {
            if (!$(this).find("option:selected").val().trim()) {
                isValidForm = false;
            }
        });
        $(this.form).find("#subscribe, #business-btn, #contact-btn").prop("disabled", !isValidForm);
        return isValidForm;
    }
    $("#subscribe, #business-btn, #contact-btn").closest("form").submit(function() {
        return checkForm.apply($(this).find(":input")[0]);
    }).find(":input[required]:visible").on("change keyup", checkForm).keyup();
});
...
(function($) {
    ...
    $(document).on("click", "a", function() {
        ...
        if (this_href && (source || medium || campaign || term || content)) {
            if (this_href.indexOf("?") != -1) this_href = this_href + "&"; else this_href = this_href + "?";
